            ...
            Scaffold(
                        ...
                        navigationIcon = {
                            Icon(
                                modifier = Modifier
                                    ...
                                    .clickable {
                                        viewmodel.processCommand(EditNoteViewmodel.EditNoteCommand.Back)
                                    },
                ...
                Column(
                    ...
                    TextField(
                        ...
                        placeholder = {
                            Text(
                                text = stringResource(R.string.title_editing),
                                fontSize = 24.sp,
                                fontWeight = FontWeight.Bold,
                    ...
                    Button(
                        ...
                        Text(
                            text = stringResource(R.string.save_note_editing),
                        )
                    }
                }
            }
